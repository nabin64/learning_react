...
const App = () => {
    ...
    const [circle, setCicle] = useState(10)
    const changeColor = (e) => {
    ...
    return (
        <div>
            ...
            <input onChange={makeCicle} placeholder="change color" />
            <div style={{ height: height + 'px', width: width + 'px', backgroundColor: color, borderRadius: circle + '%' }}>
